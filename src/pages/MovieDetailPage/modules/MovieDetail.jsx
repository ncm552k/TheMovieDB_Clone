...
import ModalPoster from '../../components/MovieDetailComponents/ModalPoster/ModalPoster.jsx'
...
const MovieDetail = () => {
  ...
  return (
    <section className='relative MovieDetail'>
      ...
      >
        <div style={handleStyleBgImg(color)} className='absolute inset-0 custom_bg overlay' />
        <div className='original_header flex gap-x-[40px] ml-[56px] pr-[56px]'>
          <div onClick={() => handleOpen()} className='relative poster_wrapper w-[300px]'>
            <div className='relative poster_img'>
              <img
                ...
                id='poster_img'
                className='rounded-2xl overflow-hidden w-[300px] h-[450px] hover:cursor-pointer'
              />
              <img
                ...
                id='poster_img'
                className='rounded-2xl absolute opacity-0 w-[300px] h-[450px] hover:cursor-pointer'
                onLoad={() => {
          ...
          <ModalPoster open={open} handleClose={handleClose} />
            ...
            <div className='flex items-center mb-[20px]'>
              ...
              <div className='flex ml-[20px] action gap-x-[20px]'>
                ...
                <button
                  ...
                  id='play_trailer'
                  className='flex items-center ml-2 cursor-pointer trailer gap-x-2 hover:opacity-75'
                >
                  <i className='fa-solid fa-play' />
                  <p className='ml-2 font-semibold'>Play Trailer</p>
                </button>
              </div>
            </div>
            <div>
