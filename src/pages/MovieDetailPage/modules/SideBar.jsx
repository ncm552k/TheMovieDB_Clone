...
// import LineChart from '../../components/MovieDetailComponents/LineChart'
    ...
    <div className='grey_column ml-[30px] mt-[30px]'>
      <div>
        <section className='split_column season'>
          <div>
            <div className='column no_bottom_pad'>
              <section className='facts left_column mb-[20px]'>
                ...
                {location.includes('tv') ? (
                  <ul className='networks mb-[20px]'>
                    <li>
                      <a href='/network/94?language=vi'>
                        <img
                          loading='lazy'
                          alt='See more TV shows from MBS...'
                          src='https://www.themoviedb.org/t/p/h30/7RNXnyiMbjgqtPAjja13wchcrGI.png'
                          srcSet='https://www.themoviedb.org/t/p/h30/7RNXnyiMbjgqtPAjja13wchcrGI.png'
                        />
                      </a>
                    </li>
                    <li>
                      <a href='/network/469?language=vi'>
                        <img
                          loading='lazy'
                          alt='See more TV shows from NHK G...'
                          src='https://www.themoviedb.org/t/p/h30/8hWXAayakmOUZPzmJsqxN7WYnd3.png'
                          srcSet='https://www.themoviedb.org/t/p/h30/8hWXAayakmOUZPzmJsqxN7WYnd3.png'
                        />
                      </a>
                    </li>
                    <li>
                      <a href='/network/614?language=vi'>
                        <img
                          loading='lazy'
                          alt='See more TV shows from Tokyo MX...'
                          src='https://www.themoviedb.org/t/p/h60/hSdroyVthq3CynxTIIY7lnS8w1.png'
                          srcSet='https://www.themoviedb.org/t/p/h60/hSdroyVthq3CynxTIIY7lnS8w1.png'
                        />
                      </a>
                    </li>
                  </ul>
            ...
            <div className='column right_column'>
              <section className='content_score mb-[30px]'>
                ...
                <div className='content_score w[260px] h-[38px] overflow-hidden rounded-xl bg-grayBold'>
                  <div
                    style={{ width: `${Math.ceil(dataMovie.vote_average * 10)}%` }}
                    className={`true flex items-center px-[12px] w-[94%] h-full ${
                      Math.ceil(dataMovie.vote_average * 10) > 80 ? 'bg-info' : 'bg-[#200b0b]'
                    } `}
                  >
                    <p className='text-white'>{Math.ceil(dataMovie.vote_average * 10)}</p>
                  </div>
                </div>
                <p>Almost there...</p>
              </section>
          ...
          <div>
            <p className='inline-block text-white prounded new_button mt-[30px] bg-[#200a0a] py-[6px] px-[20px] rounded-[100px]'>
          ...
          <div className='report_issue mt-[20px]'>
